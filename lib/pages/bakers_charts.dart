...
class BakersCharts extends StatefulWidget {
  @override
  State<BakersCharts> createState() => _BakersChartsState();
}

class _BakersChartsState extends State<BakersCharts> {
  List<SalesDetails> sales = [];
  late TooltipBehavior _tooltipBehavior;

  Future<String> getJsonFromFirebase() async {
    String url = 'https://bakerscharts-default-rtdb.firebaseio.com/data.json';
...
class SalesDetails {
  SalesDetails(this.shopbakers, this.bakersCount);
  final String shopbakers;
  final int bakersCount;
  factory SalesDetails.fromJson(Map<String, dynamic> parsedJson) {
    return SalesDetails(
        parsedJson['shopbakers'].toString(), parsedJson['bakersCount']);
  }
}
