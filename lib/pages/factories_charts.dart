...
class FactoriesCharts extends StatefulWidget {
  @override
  State<FactoriesCharts> createState() => _FactoriesChartsState();
}

class _FactoriesChartsState extends State<FactoriesCharts> {
  List<SalesDetails> sales = [];
  late TooltipBehavior _tooltipBehavior;

  Future<String> getJsonFromFirebase() async {
    String url = 'https://factorycharts-default-rtdb.firebaseio.com/data.json';
...
class SalesDetails {
  SalesDetails(this.shopfactory, this.factoryCount);
  final String shopfactory;
  final int factoryCount;
  factory SalesDetails.fromJson(Map<String, dynamic> parsedJson) {
    return SalesDetails(
        parsedJson['shopfactory'].toString(), parsedJson['factoryCount']);
  }
}
