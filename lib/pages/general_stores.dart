...
class GeneralCharts extends StatefulWidget {
  @override
  State<GeneralCharts> createState() => _GeneralChartsState();
}
...
class _GeneralChartsState extends State<GeneralCharts> {
  ...
  Future<String> getJsonFromFirebase() async {
    String url =
        'https://filestorage-7b825-default-rtdb.firebaseio.com/data.json';
...
class SalesDetails {
  SalesDetails(this.shopgeneral, this.generalCount);
  final String shopgeneral;
  final int generalCount;
  factory SalesDetails.fromJson(Map<String, dynamic> parsedJson) {
    return SalesDetails(
        parsedJson['shopgeneral'].toString(), parsedJson['generalCount']);
  }
}
