...
class HotelsCharts extends StatefulWidget {
  @override
  State<HotelsCharts> createState() => _HotelsChartsState();
}

class _HotelsChartsState extends State<HotelsCharts> {
  List<SalesDetails> sales = [];
  late TooltipBehavior _tooltipBehavior;

  Future<String> getJsonFromFirebase() async {
    String url =
        'https://hotelscharts-d040c-default-rtdb.firebaseio.com/data.json';
...
class SalesDetails {
  SalesDetails(this.shophotels, this.hotelsCount);
  final String shophotels;
  final int hotelsCount;
  factory SalesDetails.fromJson(Map<String, dynamic> parsedJson) {
    return SalesDetails(
        parsedJson['shophotels'].toString(), parsedJson['hotelsCount']);
  }
}
