...
class ProductReg extends StatefulWidget {
  ProductReg({Key? key}) : super(key: key);
...
class _ProductRegState extends State<ProductReg> {
  ...
  CollectionReference students =
      FirebaseFirestore.instance.collection('productreg');
                      ...
                      onPressed: () {
                        ...
                        showDialog(
                            ...
                            builder: (context) => AlertDialog(
                                  content: Text("You request has been submitted and will soon approach you"),
                                ));
                      },
                      style: ButtonStyle(
                          backgroundColor:
